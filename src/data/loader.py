...
def load_or_generate_panel(
    ...
    with log_phase("load_or_generate_panel", logger):
        ...
        if not os.path.exists(data_path):
            ...
            is_synthetic = os.path.exists(paths.synthetic_marker_for(data_path))
            if is_synthetic:
                logger.info(
                    "Panel carries a synthetic-provenance marker; this run is "
                    "NOT official and will not persist tuned parameters."
                )
